...
TEST_F(
    ShiftRegisterTest,
    testThatTheLevelActivatorTurnsOnAGivenLevelWhenItIsInSpecificBoundsAlsoCheckThatTheShiftRegisterUpdatesTheShiftRegisterBitAfterALevelWasTurnedOn) {
  int turnedOn = 4;
...
TEST_F(
    ShiftRegisterTest,
    testThatTheLevelActivatorTurnsOffAGivenLevelWhenItIsInSpecificBoundsAlsoCheckThatTheShiftRegisterUpdatesTheShiftRegisterBitAfterALevelWasTurnedOff) {
...
TEST_F(
    ShiftRegisterTest,
    testThatTheColumnActivatorTurnsOnAGivenColumnWhenItIsInSpecificBoundsAlsoCheckThatTheShiftRegisterUpdatesTheShiftRegisterBitAfterAColumnWasTurnedOn) {
...
TEST_F(ShiftRegisterTest,
       testThatTheColumnActivatorNeverTurnsOnAColumnWhenTheColumnIndexIsNegativeAlsoCheckThatTheShiftRegisterBitIsNotUpdatedInThisCase) {
...
TEST_F(
    ShiftRegisterTest,
    testThatTheColumnActivatorTurnsOffAGivenColumnWhenItIsInSpecificBoundsAlsoCheckThatTheShiftRegisterUpdatesTheShiftRegisterBitAfterAColumnWasTurnedOff) {
...
TEST_F(ShiftRegisterTest,
       testThatTheColumnActivatorNeverTurnsOffAColumnWhenTheColumnIndexIsNegativeAlsoCheckThatTheShiftRegisterBitIsNotUpdatedInThisCase) {
