...
int LedCountOnHeartAccerlertionRationMapper::mapToInt(float accelerationRatio) { return (int)(accelerationRatio * MAX_LEDS); }
...
MovementShow::MovementShow(Gyroscope *gyroscope) { this->gyroscope = gyroscope; }
...
RandomLedBlinkMovementShow::RandomLedBlinkMovementShow(LedHeart *heart, LedBrightnessAccelerationRatioMapper *ratioMapper, IArduinoWrapper *wrapper,
                                                       float changeLightsThreshold)
    : MovementShowActionMapper(heart, ratioMapper) {
